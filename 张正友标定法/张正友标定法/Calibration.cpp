...
int main()
{
	...
	Size board_size = Size(6, 4);//标定板上每行、列的内角点数，一般地，行列数不要相同
	...
	*/
	...
	for (int i = 0; i < image_count; i++)
	{
		...
		Mat image1 = imread("C:\\Users\\明友\\Desktop\\新建MFC\\采集图片\\导向盘.jpg");
		Mat image2;
		remap(image1, image2, mapx, mapy, INTER_LINEAR);
		imwrite("C:\\Users\\明友\\Desktop\\新建MFC\\采集图片\\导向盘孔标定.jpg", image2);
		Mat image3 = imread("C:\\Users\\明友\\Desktop\\新建MFC\\采集图片\\主活塞.jpg");
		Mat image4;
		remap(image3, image4, mapx, mapy, INTER_LINEAR);
		imwrite("C:\\Users\\明友\\Desktop\\新建MFC\\采集图片\\主活塞轴标定.jpg", image4);
	}
	cout << "保存结束" << endl;
